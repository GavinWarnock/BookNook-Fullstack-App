...
from resources.books import UserReviewsResource, UserFavoritesResource, GetBooksInformationResource, ReviewDetailResource
...
def create_routes():
    ...
    api.add_resource(UserFavoritesResource, '/api/user_favorites/<string:book_id>')
